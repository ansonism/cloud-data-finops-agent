...
from data_finops.models import EvidenceInput, FinOpsAssessmentInput, RunStatus
from data_finops.persistence import InMemoryRunStateRepository
from data_finops.providers.mock import MockProvider
from data_finops.workflow import DEFAULT_STAGES, Workflow

NOW = datetime(2026, 1, 1, tzinfo=UTC)


def request() -> FinOpsAssessmentInput:
    return FinOpsAssessmentInput(
        case_id="test-001",
