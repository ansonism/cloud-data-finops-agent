...
from .models import ExecutionContext, FinOpsAssessmentInput
from .observability import configure_logging
from .persistence import JsonRunStateRepository
from .providers.mock import MockProvider
from .workflow import Workflow

app = typer.Typer(help="Cloud Data FinOps Agent")
...
def run(
    ...
    try:
        request = FinOpsAssessmentInput.model_validate_json(input_file.read_text(encoding="utf-8"))
