# SKILL.md — Cloud Data FinOps Agent
    ...
    - Cloud billing exports and platform usage
- Warehouse/cluster/query metrics
- Tags, owners, environments and cost centers
- SLOs and workload criticality
- Reservations/commitments and pricing metadata
...
- Risk and confidence for each recommendation
- Owner/action backlog
- Before/after KPI plan
...
- `savings_calculator`
    ...
    - 1. `ingest_and_normalize_cost_usage`
- 2. `establish_baselines`
- 3. `detect_anomalies_and_cost_drivers`
- 4. `identify_optimization_opportunities`
- 5. `estimate_savings_and_risk`
- 6. `validate_against_slos_and_constraints`
- 7. `rank_recommendations`
- 8. `produce_finops_action_plan`
    ...
    Maintain a provider-neutral interface in `src/data_finops/providers/base.py`.
